...
# load dataset
train_ds = datasets.CIFAR10(path2data, download=True, transform=transforms.ToTensor())
val_ds = datasets.CIFAR10(path2data, download=True, transform=transforms.ToTensor())
...
val_dl = DataLoader(val_ds, batch_size=64, shuffle=True, num_workers=4)
